...
const greetings = [
	...
	`<p>Hi there! Thanks for stopping by and checking me out. I'm <span class="name" id="my-name">Sammy</span>, ${age}, and I'm an animal loving <span class="alt-highlight" id="my-title">SWE</span> who wants to get involved in all sorts of new technology. <br /> I code, create and love to learn new things! Trying my hands on leetcode at the moment.</p>`,
];
