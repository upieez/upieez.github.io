...
const greetings = [
	`<p>I hope you are well and good fellow reader! I'm <span class="name" id="my-name">Samuel</span>, ${age} years old this year and I'm a tech enthusiast who happens to also be a <span class="alt-highlight" id="my-title">web developer</span> with front & back end capability. I code, create and love to learn new things! Always excited for challenges.</p>`,
